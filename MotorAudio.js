    ...
    constructor(gen, startX, startY, anguloInicial, padre, params, ctx) {
        ...
        if (this.padre) {
            ...
            this.adn = {
                ...
                maxVigor: rnd(1.2, 2.0), // NUEVO: Tope máximo de crecimiento para ramas ganadoras
                escalaGlobal: rnd(0.5, 1.15) // NUEVO: Genética de tamaño del árbol (Miniatura vs Gigante)
            };
        ...
        if (this.gen > 0) {
            ...
            let bonoDir = 0;
            if (vigor > 0) {
                // NUEVO: El boost máximo ahora depende del ADN y es menos explosivo
            ...
            // NUEVO: Limitamos el crecimiento extremo usando el ADN del árbol
        ...
        // NUEVO: Aplicamos la escala global a la longitud final para generar árboles enanos o grandes
