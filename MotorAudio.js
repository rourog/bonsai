...
export const DICCIONARIO_BOTANICO = {
    hojas: [
        ...
        { id: 'palmera', nombre: 'Fronda Palmera' },   // NUEVA
        { id: 'cannabis', nombre: 'Palmeada (Cannabis)' } // NUEVA
    ],
    flora: [
        ...
        { id: 'flor-azul', nombre: 'Loto Azul' },      // NUEVA
        { id: 'flor-morada', nombre: 'Jacaranda' },    // NUEVA
        { id: 'limon', nombre: 'Limones' },
        { id: 'naranja', nombre: 'Naranjas' },         // NUEVA
        { id: 'baya-roja', nombre: 'Baya Roja' },
        { id: 'mora', nombre: 'Zarzamoras' },          // NUEVA
...
export function generarPathHoja(forma, w, l) {
    switch(forma) {
        ...
        // Hoja palmeada de 5 puntas con hendiduras profundas
...
export class FrutoFlor {
    constructor(tipo, startX, startY, ctx) { 
        ...
        if (tipo === 'aleatorio') {
            // El modo caos ahora puede invocar todo el diccionario botánico
        ...
        // Frutos grandes caen con ángulo, flores pequeñas son más erráticas
        let esFruto = ['limon', 'platano', 'naranja'].includes(tipo);
    ...
    obtenerDatosMorfologicos(tipo) {
        // La figura matemática que compone la fruta o flor
        switch(tipo) {
            ...
            // Un racimo de 3 círculos para simular una zarzamora o blueberry cluster
